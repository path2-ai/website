...
const integrations = [
    {
        ...
        image: "openai",
        highlightE: true,
        highlightEMobile: true,
        highlightTMobile: true,
        highlightLMobile: true,
    },
    {
        name: "GSheet",
        image: "gsheet",
...
const integrationsOnMobile = integrations.slice(0, 15)
            ...
            <main >
                <div className="relative px-6 max-w-5xl mx-auto lg:px-8">
                    ...
                    <div className="block md:hidden">
                        <div className="grid grid-cols-3 gap-4 absolute mt-16 inset-0">
                            {integrationsOnMobile.map((integration, index) => (
                                <div key={index} className={classNames(
                                    "mx-auto w-fit h-fit p-6 rounded-2xl ring-1 ring-gray-500 shadow-[0_0px_20px_2px_rgba(255,255,255,0.1)]",
                                    (index % 3 == 1) ? (
                                        'opacity-100'
                                    ...
                                    ((currentHighlighted == "E" && integration.highlightEMobile) ? (
                                        "bg-yellow-800 border border-yellow-500"
                                    ) : (currentHighlighted == "T" && integration.highlightTMobile) ? (
                                        "bg-blue-800 border border-blue-500"
                                    ) : (currentHighlighted == "L" && integration.highlightLMobile) ? (
                                        "bg-green-800 border border-green-500"
                                    ) : (
                                        "bg-gradient-to-r from-gray-800 to-neutral-800"
                                    ))
            ...
            <div className="pt-32 relative mx-auto rounded-2xl w-fit justify-center">
                ...
                <div className="mt-10 flex flex-col text-gray-300">
                    <div className="text-lg flex flex-col mx-auto items-center">
                        <div>Create pipelines for your natural language. Choose from the below extractors, transformers, and loaders.</div>
                    </div>
                </div>
            </div>
        </div >
