                                ...
                                <div className="sm:flex sm:items-start">
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div className="mt-2">
                                            ...
                                            <p className="mt-2 text-sm text-gray-300">
                                                <span className='font-semibold'>While you're working on batches of data, we charge only 1 credit per 100 items processed</span>, so you can be creative and answer critical questions for your data. <span className='font-semibold'>Once you put workflows into a realtime setting, we charge one credit per item (aka task) processed</span>. And finally, <span className='font-semibold'>we charge 1 credit per 10MB of data stored, per month</span>.
                                            </p>
                                            <p className="mt-2 text-sm text-gray-300">
