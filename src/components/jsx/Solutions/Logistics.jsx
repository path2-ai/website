...
const stats = [
    { id: 1, name: 'Improved service via automation', value: 'Up to 65%', reference: 'McKinsey', link: 'https://www.mckinsey.com/industries/metals-and-mining/our-insights/succeeding-in-the-ai-supply-chain-revolution' },
    { id: 2, name: 'Cost savings via automation', value: 'Up to 40%', reference: 'McKinsey', link: 'https://www.mckinsey.com/industries/travel-logistics-and-infrastructure/our-insights/distraction-or-disruption-autonomous-trucks-gain-ground-in-us-logistics' },
    { id: 3, name: 'saved per day per operator', value: 'Up to 1 hour', reference: null, link: null },
]
...
const options = [
    ...
    },
    {
        ...
        description: "Automatically categorize incoming emails, detect sentiment (e.g. positive, negative, neutral), and extract information (e.g. item, quantity, address, etc.)",
        icon: IconInbox,
    }, {
...
const steps = [{
    title: "New tech makes it all possible.",
    ...
    icon: IconNumber1,
    image: "email-intelligence"
}, {
    title: "Scaleable, customizable applications",
    ...
    title: "Massive improvements via automation",
    description: "According to a report by McKinsey, logistics companies can improve their services by up to 65% via automation in sales, marketing, and customer service.",
    icon: IconNumber3,
    image: "communication"
}, {
    title: "Reduce operating costs",
    description: "Via automated synchronization to your transport management system and other IT systems, improving your email channels alone can save you a large amount of operational overhead.",
    icon: IconNumber4,
    image: "sigmoid"
}]
                    ...
                    <div className="mx-auto max-w-7xl py-16 sm:py-20">
                        <div>
                            <div>
                                <h1 className="text-white text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">
                                    <div>Automated email intelligence for the </div>
                                ...
                                <p className="mt-6 text-xl leading-8 text-transparent bg-clip-text bg-gradient-to-r from-gray-500 via-gray-300 to-gray-500 sm:text-center">
                                    Through language-based AI applications.
                                </p>
                            </div>
                        </div>
                        <div className='my-28'>
                        ...
                        <div className='my-14'>
                            <div className="mx-auto w-full">
                                ...
                                <EmailAnalytics industry={'logistics'} />
                            </div>
                        </div>
