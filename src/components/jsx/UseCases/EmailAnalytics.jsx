...
export function EmailAnalytics({ devIsSelected }) {
                        ...
                        <div className='p-[1px] rounded-md bg-gradient-to-b from-gray-800 to-neutral-900'>
                            <div className='flex flex-row items-center justify-between px-4 py-1 text-gray-500 text-sm rounded-t-md bg-neutral-900 border-b border-gray-800'>
                                ...
                                <Menu as="div" className="relative inline-block text-left">
                                    <div>
                                        <Menu.Button className="inline-flex w-full justify-center rounded-md border border-gray-900 px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-200 hover:bg-neutral-800 focus:outline-none">
                                            Choose an example
