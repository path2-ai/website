                                        ...
                                        <div className="bg-neutral-900 px-6">
                                            <div className="h-16 flex flex-row items-center justify-between">
                                                ...
                                                {showTransformedContent ? (
                                                    <button
                                                        type="button"
                                                        className="inline-flex items-center justify-center rounded-md border border-gray-700 bg-neutral-900 px-4 py-2 text-sm font-medium text-gray-300 shadow-sm hover:bg-neutral-800 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
                                                        onClick={() => setShowTransformedContent(false)}
                                                    >
                                                        <IconMicrophone className="-ml-1 mr-2 h-5 w-5 text-gray-500" aria-hidden="true" />
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={() => setShowTransformedContent(true)}
                                                    >
                                                        <IconSeo className="-ml-1 mr-2 h-5 w-5 text-gray-500" aria-hidden="true" />
                                        ...
                                        {showTransformedContent ? (
                                            <div>
                                                ...
                                                <div className='border-t border-gray-800 p-6 text-gray-300 text-sm leading-6 font-medium'>
                                                    ...
                                                    <ul role="list" className="mt-4 list-disc pl-5 space-y-2">
                                                        <li>
                                                            An API in workflow, which will fetch the latest stock news and enrich it with sentiment.
                                                        </li>
                                                        <li>A classifier in refinery that can enrich newly incoming data with gates.</li>
