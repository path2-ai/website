    ...
    return (
        ...
        <div className='my-20 text-white'>
            ...
            <div className='flex flex-row items-center space-x-4'>
                ...
                >
                    <IconAlignJustified className='text-neutral-500 w-6 h-6' />
                </div>
                <div>
                ...
                <div className='p-6 relative flex flex-col space-y-6'>
                    <div className={classNames(
                        ...
                        <div className='p-[1px] rounded-md bg-gradient-to-b from-gray-800 to-neutral-900'>
                            ...
                            >
                                <button
                                    className='flex items-center justify-center h-10 w-10 rounded-full bg-red-500'
                                    onClick={() => {
                                        if (permission) {
                                            if (!isRecording) {
                                                startRecording()
                                ...
                                <div>
                                    {permission ?
                                        isRecording ? (
                                            ...
                                            "Click to get permission to use your microphone"
                                        )}
                                </div>
                            </div>
                        </div>
