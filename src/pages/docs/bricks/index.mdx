...
![](http://kern-assets.s3-website.eu-central-1.amazonaws.com/website/screenshots/brick-classifier.png)

Classifiers summarize information. Think of them as functions returning values, i.e. one input = one output.

## Extractors

![](http://kern-assets.s3-website.eu-central-1.amazonaws.com/website/screenshots/brick-extractor.png)

Extractors retrieve information. Think of them as functions yielding values, i.e. one input = arbitrary number of output.

## Generators

![](http://kern-assets.s3-website.eu-central-1.amazonaws.com/website/screenshots/brick-generator.png)
