...
![](https://kern-assets.s3.amazonaws.com/website/screenshots/workflow-editor-skeleton.png)
...
![](https://kern-assets.s3.amazonaws.com/website/screenshots/workflow-editor-flow.png)
...
![](https://kern-assets.s3.amazonaws.com/website/screenshots/workflow-template.png)
...
![](https://kern-assets.s3.amazonaws.com/website/screenshots/workflow-node-config.png)
...
![](https://kern-assets.s3.amazonaws.com/website/screenshots/workflow-nocode-config.png)
...
![](https://kern-assets.s3.amazonaws.com/website/screenshots/workflow-condition-eval.png)

If you want to send the data to the next node in any case, you can simply write `True` into the condition editor.
![](https://kern-assets.s3.amazonaws.com/website/screenshots/workflow-condition-true.png)
