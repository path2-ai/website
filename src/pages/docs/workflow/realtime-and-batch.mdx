...
![](https://kern-assets.s3.amazonaws.com/website/screenshots/workflow-creation.png)

If you start from scratch, you can now define which type of workflow you want to build.

![](https://kern-assets.s3.amazonaws.com/website/screenshots/workflow-creation-from-scratch.png)
